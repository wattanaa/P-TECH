...
export default function AboutView({ initialSection, setInitialSection } = {}) {
  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16" id="about-view">
      {
    /* 1. History & Vision */
  }
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-6 text-slate-500 pt-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold text-slate-700">ก่อตั้งมามากกว่า {(/* @__PURE__ */ new Date()).getFullYear() + 543 - parseInt(collegeInfo.foundedYear)} ปี</span>
            </div>
            <div className="flex items-center space-x-2">
  ...
  />
    ...
    /* Administrators list Grid layout */
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {administrators.map((admin, idx) => <div
    key={idx}
  ...
  />
    ...
    >
                  ...
                  {isExpanded ? <ChevronUp className="w-5 h-5 text-slate-400 shrink-0 ml-2" /> : <ChevronDown className="w-5 h-5 text-slate-400 shrink-0 ml-2" />}
                </button>
  ...
  >
    ...
    className={`w-full px-4 py-2 text-xs md:text-sm rounded-xl border focus:outline-none focus:ring-2 focus:ring-brand-primary ${contactErrors.name ? "border-red-300 focus:ring-red-100" : "border-slate-200"}`}
  />
    ...
    onChange={handleInputChange}
    className={`w-full px-4 py-2 text-xs md:text-sm rounded-xl border focus:outline-none focus:ring-2 focus:ring-brand-primary ${contactErrors.email ? "border-red-300 focus:ring-red-100" : "border-slate-200"}`}
  />
    ...
    onChange={handleInputChange}
    className={`w-full px-4 py-2 text-xs md:text-sm rounded-xl border focus:outline-none focus:ring-2 focus:ring-brand-primary ${contactErrors.subject ? "border-red-300 focus:ring-red-100" : "border-slate-200"}`}
  />
    ...
    onChange={handleInputChange}
    className={`w-full px-4 py-2 text-xs md:text-sm rounded-xl border focus:outline-none focus:ring-2 focus:ring-brand-primary ${contactErrors.message ? "border-red-300 focus:ring-red-100" : "border-slate-200"}`}
  />
