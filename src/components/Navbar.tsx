...
import { GraduationCap, Menu, X, Phone, MapPin, ChevronDown, Lock } from "lucide-react";
...
interface NavbarProps {
  ...
  setAboutSection?: (section: string) => void;
}

export default function Navbar({ activeTab, setActiveTab, setAboutSection }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm" id="main-header">
          ...
          <div className="hidden lg:flex items-center space-x-1" id="desktop-menu">
            ...
            >
              <button
                ...
                className={`relative px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center space-x-1 ${
                  activeTab === "about"
                    ? "text-brand-primary font-bold"
                    : "text-slate-600 hover:text-brand-primary hover:bg-slate-50"
                }`}
            ...
            <div className="px-4 pt-2 pb-6 space-y-1 sm:px-6">
              ...
              <div className="space-y-1">
                <button
                  ...
                  className={`w-full text-left flex justify-between items-center px-4 py-3 rounded-lg text-base font-medium transition-colors ${
                    activeTab === "about"
                      ? "bg-blue-50 text-brand-primary font-bold border-l-4 border-brand-primary"
                      : "text-slate-600 hover:bg-slate-50 hover:text-brand-primary"
                  }`}
